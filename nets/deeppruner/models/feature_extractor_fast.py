...
from nets.deeppruner.models.submodules import BasicBlock, convbn_relu
...
class feature_extraction(nn.Module):
    ...
    def forward(self, input):
        ...
        outputs = namedtuple("Outputs", ['output_feature', 'output_raw', 'output1'])

        return outputs(output1, output_raw, output_feature)
